...
DEFAULTS = {
    ...
    'CONSOLE_WEB_URL': 'https://halfjourney.xyz',
    'CONSOLE_API_URL': 'https://halfjourney.xyz',
    'SERVICE_API_URL': 'https://api.halfjourney.xyz',
    'APP_WEB_URL': '',
    'FILES_URL': '',
    'S3_ADDRESS_STYLE': 'auto',
    'STORAGE_TYPE': 'local',
    'STORAGE_LOCAL_PATH': 'storage',
    'CHECK_UPDATE_URL': 'https://updates.halfjourney.xyz',
    ...
    'HOSTED_FETCH_APP_TEMPLATES_REMOTE_DOMAIN': 'https://tmpl.halfjourney.xyz',
