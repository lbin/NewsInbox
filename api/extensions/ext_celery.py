...
def init_app(app: Flask) -> Celery:
    ...
    imports = [
        ...
        "schedule.test_crawl_from_rsshub_task",
    ]
    ...
    beat_schedule = {
        ...
        # },
        "test_crawl_from_rsshub_task": {
            "task": "schedule.test_crawl_from_rsshub_task.crawl_from_rsshub_task",
            "schedule": crontab(minute=22, hour=18),
        },
        # "daily_summary_task": {
