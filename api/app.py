...
@app.route("/pdf/<filepath>/<filename>")
def pdf_file(filepath, filename):
    return send_file(f"templates/{filepath}/{filename}")
...
def summary():
    ...
    send_to_feishu(conf(), content, None, None, url, "MiniAPP", published, raw_content)
