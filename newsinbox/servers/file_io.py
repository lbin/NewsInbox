...
def load_key_words():
    ...
    with open("schedule/key_web_list.txt") as f:
        key_web_list = f.readlines()
        key_web_list = [word.strip() for word in key_web_list]
        
    return key_words, black_words, key_web_list
