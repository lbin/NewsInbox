...
available_setting = {
    ...
    "feishu_app_id": "",
    "feishu_app_secret": "",
    "prompt": "我需要对下面引号内文档进行总结, 总结输出包括以下四个部分:\n标题\n一句话总结\n关键要点,用数字序号列出3-5个文章的核心内容\n标签: #xx #xx #xx. 以JSON格式返回: {title: 标题, summary: 总结的内容, key_points: {'1': 关键要点1; '2': 关键要点; '3': 关键要点}, tags: [#xx, #xx, #xx]}",
    "max_words": 8000,
    ...
    def load_user_datas(self):
        try:
            with open(os.path.join(get_appdata_dir(), "user_datas.pkl"), "rb") as f:
                ...
                logging.debug("[Config] User datas loaded.")
        except FileNotFoundError as e:
            logging.debug("[Config] User datas file not found, ignore.")
        except Exception as e:
            logging.debug("[Config] User datas error: {}".format(e))
            self.user_datas = {}
