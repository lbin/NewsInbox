...
// APIClient manages communication with the Academic Graph API API v1.0
...
type APIClient struct {
	...
	AuthorDataApi *AuthorDataApiService

	PaperDataApi *PaperDataApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AuthorDataApi = (*AuthorDataApiService)(&c.common)
	c.PaperDataApi = (*PaperDataApiService)(&c.common)
