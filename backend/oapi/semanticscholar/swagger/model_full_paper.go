...
type FullPaper struct {
	...
	Authors []AllOfFullPaperAuthorsItems `json:"authors,omitempty"`
	Citations []BasePaper `json:"citations,omitempty"`
	References []AllOfFullPaperReferencesItems `json:"references,omitempty"`
